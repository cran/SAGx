...
/* re-written to suit the purposes of GSEA.t.mean PBG 19MAY06 */
...
void newboot(double *indata,int *NR,int *NC,double *xhat,int *NRP ,int *NCP,double *xmat,double *contrast,int *smooth,int *B, double *npar,double *scalek,double *ss,double *diffs,double *sses, int *LC){  /*NR =ncol, *NC=nrow*/
   int i,j,k,I;
